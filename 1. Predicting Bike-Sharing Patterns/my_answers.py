...
class NeuralNetwork(object):
    ...
    def forward_pass_train(self, X):
        ...
        hidden_outputs = self.activation_function(
            np.matmul(hidden_inputs, self.weights_input_to_hidden))

        # TODO: Output layer - Replace these values with your calculations.
        final_inputs = hidden_outputs  # signals into final output layer
        # signals from final output layer
        final_outputs = np.matmul(final_inputs, self.weights_hidden_to_output)
    ...
    def run(self, features):
        ...
        hidden_outputs = self.activation_function(
            np.dot(hidden_inputs, self.weights_input_to_hidden))
